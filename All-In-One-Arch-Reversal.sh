...
sleep 15
chsh -s /usr/bin/bash
sudo pacman -Rns --noconfirm --quiet pipes.sh yt-dlp google-chrome brave-bin zen-browser-bin firefox balena-etcher ventoy-bin git curl wget fish android-tools android-udev heimdall gvfs gvfs-mtp cava figlet lolcat sl usbutils ptyxis cowsay fastfetch vim nano bat eza yay
